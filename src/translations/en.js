export const en = {
  ...
  updateCustomer: "Update Person",
  addVendor: "Add Merchant",
  updateVendor: "Update Merchant",
  ...
  customersCount: "People",
  vendorsCount: "Merchants",
  ...
  productService: "Tag (Optional)",
  selectCustomer: "Select person...",
  selectVendor: "Select merchant...",
  ...
  foreignKeysExplanation: "Optionally link transactions to people, merchants, and items for detailed tracking",
  saving: "Saving...",
  ...
  deleteCustomerConfirm: "Are you sure you want to delete this person?",
  deleteVendorConfirm: "Are you sure you want to delete this merchant?",
  ...
  categoriesHelp: "Organize your transactions using categories and subcategories for better tracking",
